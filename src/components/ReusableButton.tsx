...
const ReusableButton: React.FC<ReusableButtonProps> = ({
  ...
  return (
    <button
      className={`px-5 py-3 text-white font-semibold bg-[#F0B73F] rounded-lg  items-center ${showArrow ? 'justify-center md:justify-start space-x-3' : 'justify-center'} mx-auto md:mx-0 ${widthClass} ${className} transition duration-200 hover:bg-[#CA9A35]  hover:shadow-lg`}
      onClick={onClick}
    >
      <div className='flex'>
