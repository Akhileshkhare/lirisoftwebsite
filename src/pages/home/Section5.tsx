...
//   return (
//     <section className='w-full  flex items-center justify-between bg-gray-100  h-[607px]'>
//      <div className="w-4/5 mx-auto text-center  py-0 ">
//      <h2 className="text-5xl font-bold text-gray-900 mb-[90px]">
