          ...
          <div className="w-full md:w-3/4 flex flex-col items-center md:items-stretch sm:flex-row gap-6 py-8 md:gap-3">
            {sectionData?.features?.map((feature, index) => (
              <div 
                ...
                className="flex flex-col items-center p-6 gap-6 md:gap-8 bg-[#F2F5F6] rounded-2xl w-full max-w-[215.33px] h-auto text-center cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 hover:bg-white"
              >
