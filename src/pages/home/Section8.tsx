...
//       <div className="w-4/5 mx-auto flex flex-col items-center py-0 h-[390px]">
//         <div className="flex flex-col md:flex-row justify-between items-start w-4/5">
//           <div className="w-full  max-w-[1140px] flex space-x-8 mt-[80px]">
//             <div className="flex flex-col bg-white w-full max-w-[247px] h-[300px]">
//             <h3 className="text-[#043A53] text-4xl font-bold">
//                  Lirisoft<span className="text-yellow-300">.</span>
//                 </h3>
//               <div className="w-full flex flex-row items-center mt-[40px] space-x-4">
//                 <img
//                   src="/SIcon1.svg"
//                   alt="Feature Icon"
...
//               </div>
//             </div>
//             <div className="flex flex-col bg-white w-full max-w-[395px] h-[300px] px-10">
//              <p>Since our founding in 2017, Lirisoft has specialized in IT consulting and software development. We empower non-IT organizations and software companies to enhance business performance and rapidly attract new customers.</p>
//             </div>
//             <div className="flex flex-col bg-white w-full max-w-[114px] h-[300px]">
//                 <ul className="list-none space-y-6 text-gray-900">
