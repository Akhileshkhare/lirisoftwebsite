  ...
  return (
    <section className="w-full px-4 md:px-0 bg-[#043A53] h-[900px] md:h-[880px]">
         <div className="w-full mx-auto flex flex-col items-center justify-center">
          ...
          <h1 className='text-[38px] w-[60%] md:text-5xl font-semibold pt-[80px] md:pt-[200px]'>If you're passionate about what you do, we want you on our team.</h1>
          <h2 className='text-[#97F03F] pt-8 text-[20px]'>We are employee centric company.</h2>
          </div>
           <div className="w-full mx-auto flex text-white items-center justify-center">
      <div className="w-[75%] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left pt-[20px] md:mt-[120px] border-t border-b border-[#A9CAE7] pb-4">
        ...
        <div className="px-4 py-2 border-l border-gray-400">
        ...
        <div className="px-4 py-2 border-l border-gray-400 flex flex-row items-center justify-center">
