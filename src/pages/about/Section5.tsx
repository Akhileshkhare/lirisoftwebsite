  ...
  return (
    <section className="w-full px-4 md:px-0">
      ...
      {images.map((value, index) => (
        <div key={index} className="w-[280px] h-[220px] flex flex-col  items-center justify-center bg-white">
          <img src={value.Image} alt={`Image ${index + 1}`} className="w-[160px] h-[160px] p-4 object-contain rounded-md" />
          <p className='text-[18px]  font-bold'>{value.Name}</p>
