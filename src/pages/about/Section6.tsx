...
export default function Section6() {
  return (
    <section className="w-full px-4 md:px-0 bg-[#F2F5F6]">
               <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center md:justify-between  h-auto md:h-[800px]">
        ...
        <div className="relative h-[650px] w-full md:w-1/2 pl-0 md:pl-0  flex justify-center items-center overflow-hidden">
  {/* Rectangle 1 */}
  ...
  {/* Rectangle 3 (Image) */}
  <div className="w-[214px] h-[668px] absolute top-[75px] left-[89px] rounded-[180.5px] z-10 
  ...
  {/* Rectangle 4 */}
  <div className="w-0 h-[687px] absolute top-[93px] left-[147px] rounded-[180.5px] bg-[#F0B73F] opacity-30 z-9 
...
<div className="w-full md:w-1/2 pl-0 md:pl-4 md:h-[650px] flex justify-center items-start flex-col ">
